...
void setup() {
  ...
  bluetooth.print(" a ");
  bluetooth.print(Xmax);
  bluetooth.println(" mm.");
  bluetooth.print("Y vai de ");
  bluetooth.print(Ymin);
  bluetooth.print(" a ");
  bluetooth.print(Ymax);
  bluetooth.println(" mm.");
}
      ...
      if ((c == '\n') || (c == '\r')) {
        ...
        if (LinhaComentada) {                  // Se estiver dentro de um comentário...
          ...
          if ((c == ' ')) {
            ...
            bluetooth.println("overload - lineBuffer chegou no limite de caracteres");
            LinhaComentada = false;
          }
          else if ((c >= 'a' && c <= 'z') || (c >= 'A' && c <= 'Z')) {  
            // Se for uma letra, insere um espaço antes (se não for o primeiro caractere)
      ...
      case 'M': {
        ...
        switch (valorM) {
          case 114:  // M114 - Reportar posição atual
            ...
            bluetooth.print("Caneta na posicao : X = ");
            bluetooth.print(Xpos_mm);
            bluetooth.print("  -  Y = ");
            bluetooth.println(Ypos_mm);
            break;
 
          case 18:  // M18 - Fim do desenho
            Serial.println("Desenho finalizado!!!");
            bluetooth.println("Desenho finalizado!!!");
          ...
          case 5: // M5 - Apresentar o tempo total do desenho
            ...
            bluetooth.print("Tempo desenhando: ");
          ...
          default:
            ...
            bluetooth.print("Comando M desconhecido: M");
            bluetooth.println(valorM);
        }
        break;
      }
