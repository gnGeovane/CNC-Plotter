...
Stepper myStepperUPY(PassosPorVolta, 9,8,7,6, true);  
...
const int LineDelay = 5; // delay para dar tempo ao código em java receber "Ok" e enviar a próxima linha.
